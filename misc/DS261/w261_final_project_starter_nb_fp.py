...
data_BASE_DIR = "dbfs:/mnt/mids-w261/OTPW_12M/OTPW_12M/"
# data_BASE_DIR = "dbfs:/mnt/mids-w261/datasets_final_project_2022/parquet_airlines_data_3m/"
...
df_weather.write.mode('overwrite').parquet(f"{folder_path}/df_weather.parquet")
